...
updateHistory:
  - date: '2026-04-21'
    changes: '移除歌手/专辑/文件夹视图，简化为单一平铺列表（含文件夹列）；更新导航模式'
---
...
2. **快速定位与选择** — 平铺列表下，如何通过文件夹高效定位和选择多首歌
3. **移动端适配** — 手机上完成批量编辑，触摸交互的精确度挑战

### Design Opportunities

1. **批量操作的极致效率** — 批量选、批量改、批量确认，三步完成
2. **文件夹分组筛选** — 通过文件夹列快速筛选同一目录下的歌曲，批量设置专辑名
...
- 点击文件夹路径可筛选显示该目录下的歌曲
- 支持清除筛选，返回完整列表
- 筛选状态在顶部显示「当前筛选：path/to/folder」+「清除」按钮
