...
- Name: epic2-browse-search.spec.ts >> Epic 2: 音乐库浏览与搜索 >> Song Selection (Story 2.6) >> 选中按钮应该显示批量操作选项
- Location: e2e/epic2-browse-search.spec.ts:275:5
...
Locator: locator('button:has-text("全选")')
Expected: visible
Error: strict mode violation: locator('button:has-text("全选")') resolved to 2 elements:
    1) <button class="text-sm text-green-600 hover:text-green-700 font-medium">全选</button> aka getByRole('button', { name: '全选', exact: true })
    2) <button class="text-sm text-gray-500 hover:text-gray-700">取消全选</button> aka getByRole('button', { name: '取消全选' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('button:has-text("全选")')
